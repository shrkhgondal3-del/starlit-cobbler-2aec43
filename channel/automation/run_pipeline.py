...
Steps:
  ...
  3. [agent/API]           — ElevenLabs MP3s, HeyGen avatars, Higgsfield B-roll
...
Usage:
  ...
  python run_pipeline.py assemble --project projects/01-foreigners-buy-property-ksa --allow-placeholders
"""
